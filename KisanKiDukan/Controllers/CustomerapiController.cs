...
namespace KisanKiDukan.Controllers
{
    public class CustomerapiController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/Customerapi/SignupCustomer")]
        ...
        [HttpPost, Route("api/Customerapi/OtpVerifywithRegistration")]
        ...
        [HttpPost,Route("api/Customerapi/LoginMobileOrEmail")]
        ...
        [HttpPost, Route("api/Customerapi/MobileOrEmailOtpVerify")]
        ...
        [HttpPost, Route("api/Customerapi/LoginWithEmail")]
        [AllowAnonymous]
        ...
        [HttpGet, Route("api/Customerapi/UserProfile")]
        ...
        //====ChangePWD api====
        [HttpPost]
        [Route("api/Customerapi/ChangePWD")]
        ...
        [HttpPost]
        [Route("api/Customerapi/ChangeProfile")]
        ...
        //====ForgotPWD api====
        [HttpPost]
        [Route("api/Customerapi/ForgotPWD")]
        ...
        [HttpPost]
        [Route("api/Customerapi/GetUserByEmail")]
        ...
        //=====Wallet api====
        [HttpGet, Route("api/Customerapi/GetAmountBy")]
        ...
        [HttpPost, Route("api/Customerapi/AddWalletAmount")]
        ...
        [HttpGet, Route("api/Customerapi/GetPremiumAmt")]
        ...
        [HttpPost, Route("api/Customerapi/PremiumUser")]
        ...
        //====Bulkorder=====
        [HttpPost, Route("api/Customerapi/Bulkorder")]
